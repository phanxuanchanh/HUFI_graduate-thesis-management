...
namespace GraduateThesis.Repository.BLL.Implements
{
    public class LecturerRepository : ILecturerRepository
    {
        ...
        public Pagination<LecturerOutput> GetPagination(int page, int pageSize, string orderBy, OrderOptions orderOptions, string keyword)
        {
            return _genericRepository.GetPagination(page, pageSize, orderBy, orderOptions, keyword);
        }

        public async Task<Pagination<LecturerOutput>> GetPaginationAsync(int page, int pageSize, string orderBy, OrderOptions orderOptions, string keyword)
        {
