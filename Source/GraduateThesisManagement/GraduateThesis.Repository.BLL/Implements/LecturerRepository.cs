...
namespace GraduateThesis.Repository.BLL.Implements
{
    public class LecturerRepository : ILecturerRepository
    {
        ...
        public Pagination<LecturerOutput> GetPagination(int page, int pageSize, string orderBy, string keyword)
        {
            return _genericRepository.GetPagination(page, pageSize, orderBy, keyword);
        }

        public async Task<Pagination<LecturerOutput>> GetPaginationAsync(int page, int pageSize, string orderBy, string keyword)
        {
