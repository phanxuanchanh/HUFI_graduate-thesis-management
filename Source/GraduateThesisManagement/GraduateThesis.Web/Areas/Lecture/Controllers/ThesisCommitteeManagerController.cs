...
{
    [Area("Lecture")]
    [Route("lecture/thesisCommittee-manager")]
    [WebAuthorize]
    [AccountInfo(typeof(FacultyStaffOutput))]
    public class ThesisCommitteeManagerController : WebControllerBase<IThesisCommitteeRepository, ThesisCommitteeInput, ThesisCommitteeOutput, string>
    {
        ...
        public ThesisCommitteeManagerController(IRepository repository)
